...
router
        .on('activation/:activationToken',function (params) {
            activate(params.data.activationToken);
        })
        .on('profile',function () {
            loadProfile();
        })
        ...
        .on('userrecovery', function () {
            loadUserRecoveryInitiation();
        })
        .on('userrecovery/:recoveryToken', function (params) {
            loadUserRecoveryExecution(params.data.recoveryToken);
        })
        .on('profile/changepassword',function () {
            loadChangePassword();
        })
        .on('profile/changeemail', function () {
            loadChangeEmail();
        })
        .on((match) =>  {
            loadEntry();
...
function loadSessionNavbar() {
    $('#navbaruser').html(
        '<ul class="nav navbar-nav">'+
            '<li><a class="nav-link" href="" data-navigo>Home</a></li>'+
            '<li><a class="nav-link" href="/profile/changeemail" data-navigo>Change Email</a></li>'+
            '<li><a class="nav-link" href="/profile/changepassword" data-navigo>Change Password</a></li>'+
        '</ul>'+
        '<ul class="nav navbar-nav navbar-right">'+
            '<li><a class="nav-link"href="/profile" data-navigo><span class="glyphicon glyphicon-user"></span> '+localStorage.loginId+'</a></li>'+
            '<li><a href="/logout" data-navigo><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>'+
        '</ul>'
    );
}
...
function loadPublicNavbar() {
	$('#navbaruser').html(
        '<ul class="nav navbar-nav">'+
            '<li><a href="">Home</a></li>'+
            '<li><a href="/userrecovery" data-navigo>User Recovery</a></li>'+
        '</ul>'+
        '<ul class="nav navbar-nav navbar-right">'+
            '<li><a href="/register" data-navigo><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>'+
            '<li><a href="/login" data-navigo><span class="glyphicon glyphicon-log-in"></span> Login</a></li>'+
        '</ul>'
    );
}
